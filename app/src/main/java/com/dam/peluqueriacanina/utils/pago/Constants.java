...
package com.dam.peluqueriacanina.utils.pago;
...
public class Constants {
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Collections.singletonList("ES");
  ...
  public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS =
      new HashMap<String, String>() {{
        ...
        put("gatewayMerchantId", "BCR2DN4TYDNN7PRQ");
